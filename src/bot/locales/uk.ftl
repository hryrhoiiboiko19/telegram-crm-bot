...
internal_server_error = ⚠️ Сталася внутрішня помилка. Будь ласка, спробуйте пізніше або зверніться до підтримки.
rate_limit_exceeded = 🛑 Забагато запитів! Будь ласка, сповільніться.
